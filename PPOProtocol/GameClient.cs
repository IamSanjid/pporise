...
namespace PPOProtocol
{
    public class GameClient
    {
        ...
        private void HttpConnection_LoggedIn()
        {
            ...
            EncryptedPacketCount = Connection.CalcMd5(PacketCount + "asdfih9230dijndosf0asdpofnwe0c" + Username);
            EncryptedstepsWalked = Connection.CalcMd5(_stepsWalked + "asdfih9230dijndosf0asdpofnwe0c" + Username);
        }
        ...
        private void OnLearningMove(XmlDocument xml)
        {
            ...
            var movesLearnt = Team[slotNo].Moves.Count(move => move.Name != null && move.Data != null);
            if (movesLearnt < 4)
            ...
            try
            {
                ...
                if (ActiveBattle != null)
                {
                    if (WildPokemons.Count > 0)
                    {
                        ...
                        {
                            WildPokemons.Remove(WildPokemons.LastOrDefault());
                        }
        ...
        private void MapUpdate(string packet)
        {
            try
            {
                ...
                if (_avatarType != 0) GetTimeStamp("sendAddPlayer");
                MapUpdated?.Invoke();
            }
            catch (Exception)
            {
        ...
        private async Task HandleGetStartingInfo(string[] resObj)
        {
            ...
            await Task.Run(() =>
            {
                ...
                while (loc7 <= 99999)
                {
                    ...
                    {
                        // ReSharper disable once AccessToModifiedClosure
                        if (loc7 + 5 < resObj.ToList().IndexOf(")()(09a0jd"))
                        {
                            // ReSharper disable once AccessToModifiedClosure
                            OnInventoryUpdate(resObj[loc7 + 5]);
                        }

                        // ReSharper disable once AccessToModifiedClosure
                        loc7++;
                        if (!(loc7 + 5 < resObj.ToList().IndexOf(")()(09a0jd"))) continue;
                    }

                    loopNum = loc7;
                    if (!(loc7 + 5 < resObj.ToList().IndexOf(")()(09a0jd"))) break;
                }
            });
            Items = Items.OrderBy(o => o.Uid).ToList();
            ...
            await Task.Run(() =>
            {
                while (loc7 < 99999)
                {
                    ...
                    {
                        if (loc7 < resObj.ToList().IndexOf(")()(09a0jb")) ParsePokemon(resObj[loc7]);
                        loc7 = loc7 + 1;
                        if (loc7 >= resObj.ToList().IndexOf(")()(09a0jb")) continue;
                    }

                    loopNum = loc7;
                    if (loc7 >= resObj.ToList().IndexOf(")()(09a0jb"))
                        break;
                }
            });
            if (_swapTimeout.IsActive) _swapTimeout.Set(Rand.Next(500, 1000));
        ...
        public void GetTimeStamp(string type, string p1 = "", string p2 = "", string p3 = "", string p4 = "")
        {
            ...
            {
                var newEncryption = Connection.CalcMd5(PacketCount + "asdfih9230dijndosf0asdpofnwe0c" + Username);
                if (EncryptedPacketCount == newEncryption)
                {
                    ...
                    EncryptedPacketCount =
                        Connection.CalcMd5(PacketCount + "asdfih9230dijndosf0asdpofnwe0c" + Username);
                }
                else
                {
#if DEBUG
                    Console.WriteLine($"Something went wrong while encrypting packet count. Please Check:\nGot:{newEncryption}\nReal:{EncryptedPacketCount}");
#endif
                }
            }
            ...
            if (type == "forgetMove")
            {
                ...
                loc8.Add("packetKeyEncrypt:" +
                         Connection.CalcMd5(packetKey + "g56m1ndsbzfgyfu7iu8ojbbhgf02n9dujhid40esplpghm0cj2" +
                                            PacketCount));
            ...
            else if (type == "battleMove")
            {
                ...
                loc8.Add(Connection.CalcMd5(
                    loc8[1] + "g56m1ndsbzfgyfu7iu8ojbbhgf02n9dujhid40esplpghm0cj2" + PacketCount));
                loc8.Add(p1);
                if (p2 != "")
                    loc8.Add(p2);
                else
            ...
            else if (type == "getStartingInfo")
            {
                ...
                loc8.Add(Id);
                loc8.Add(Connection.CalcMd5(
                    _url + loc8[1] + "g56m1ndsbzfgyfu7iu8ojbbhgf02n9dujhid40esplpghm0cj2" + PacketCount + Username));
            ...
            else if (type == "sendMovement")
            {
                ...
                if (_moveType != "")
                {
                    if (_moveType == "bike")
                        loc8.Add("b");
                    else if (_moveType == "surf") loc8.Add("s");
                }
            ...
            else if (type == "buyItem")
            {
                ...
                var packetKey = Connection.GenerateRandomString(Rand.Next(10, 30));
                loc8.Add(
                    $"packetKeyEncrypt:{Connection.CalcMd5(packetKey + "g56m1ndsbzfgyfu7iu8ojbbhgf02n9dujhid40esplpghm0cj2" + PacketCount)}");
                loc8.Add($"packetKey:{packetKey}");
                loc8.Add($"packetCount:{PacketCount}");
            ...
            else if (type == "equipItem")
            {
                ...
                loc8.Add(PacketCount.ToString());
                loc8.Add(Connection.GenerateRandomString(Rand.Next(10, 30)));
                loc8.Add(Connection.CalcMd5(loc8[1] + "g56m1ndsbzfgyfu7iu8ojbbhgf02n9dujhid40esplpghm0cj2" + PacketCount));
                loc8.Add(p1);
                loc8.Add(p2);
        ...
        public bool IsMinable(int x, int y)
        {
            var tempRocks = new List<MiningObject>();
            MiningObjects.FindAll(r => r.X == x && r.Y == y && !r.IsMined)
                .ForEach(r => tempRocks.Add(r));
            if (IsGoldMember)
                MiningObjects.FindAll(r => r.IsGoldMember == IsGoldMember && r.X == x && r.Y == y && !r.IsMined)
                    .ForEach(r => tempRocks.Add(r));
            return tempRocks.Count > 0;
        }
        ...
        public bool SendFishing(string rod)
        {
            if (!Battle && _updatedMap && rod != "" && HasItemName(rod))
            {
                ...
                _fishingTimeout.Set(Rand.Next(1500, 2500));
                IsFishing = true;
                return true;
            }
        ...
        public void SendMovement(string tempDir)
        {
            ...
            {
                if (EncryptedTileY == Connection.CalcMd5(PlayerY + "asdfih9230dijndosf0asdpofnwe0c" + Username))
                {
                    PlayerY--;
                    EncryptedTileY = Connection.CalcMd5(PlayerY + "asdfih9230dijndosf0asdpofnwe0c" + Username);
            ...
            {
                if (EncryptedTileX == Connection.CalcMd5(PlayerX + "asdfih9230dijndosf0asdpofnwe0c" + Username))
                {
                    PlayerX--;
                    EncryptedTileX = Connection.CalcMd5(PlayerX + "asdfih9230dijndosf0asdpofnwe0c" + Username);
                    GetTimeStamp("sendMovement", tempDir);
            ...
            if (EncryptedstepsWalked == Connection.CalcMd5(_stepsWalked + "asdfih9230dijndosf0asdpofnwe0c" + Username))
            {
                ...
                if (_stepsWalked >= 256)
                {
                    ...
                    EncryptedstepsWalked =
                        Connection.CalcMd5(_stepsWalked + "asdfih9230dijndosf0asdpofnwe0c" + Username);
                }
            }
