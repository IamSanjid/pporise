        ...
        private bool UseAttack(bool useBestAttack)
        {
            ...
            for (int i = 0; i < ActivePokemon.Moves.Length; ++i)
            {
                ...
                if (move.Id == Explosion || move.Id == Selfdestruct ||
                    (move.Id == DoubleEdge && ActivePokemon.CurrentHealth < (_client.ActiveBattle.FullWildPokemon != null ? _client.ActiveBattle.FullWildPokemon.MaxHealth / 3 : _client.ActiveBattle.WildPokemon.MaxHealth / 3)))
                {
                    continue;
                }
                ...
                PokemonType opponentType1 = TypesManager.Instance.Type1[_client.ActiveBattle.WildPokemon.Id];
                PokemonType opponentType2 = TypesManager.Instance.Type2[_client.ActiveBattle.WildPokemon.Id];
